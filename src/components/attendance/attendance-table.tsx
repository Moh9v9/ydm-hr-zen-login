                ...
                >
                  ...
                  <TableCell>
                    <div className="flex items-center gap-2">
                      <Switch
                        ...
                        onCheckedChange={() => 
                          handleToggleStatus(record.employee_id, record.status)
                        }
                      />
                  ...
                  <TableCell>
                    <Input
                      ...
                      onChange={(e) => 
                        handleTimeChange(record.employee_id, "startTime", e.target.value)
                      }
                  ...
                  <TableCell>
                    <Input
                      ...
                      onChange={(e) => 
                        handleTimeChange(record.employee_id, "endTime", e.target.value)
                      }
                      disabled={record.status !== "Present"}
                    />
                  </TableCell>
                  <TableCell>
                    <Input
                      ...
                      onChange={(e) => 
                        handleOvertimeChange(record.employee_id, e.target.value)
                      }
                      disabled={record.status !== "Present"}
                    />
                  </TableCell>
                  <TableCell>
                    <Textarea
                      value={record.notes || ""}
                      onChange={(e) => 
                        handleNotesChange(record.employee_id, e.target.value)
                      }
                      disabled={record.status !== "Present"}
